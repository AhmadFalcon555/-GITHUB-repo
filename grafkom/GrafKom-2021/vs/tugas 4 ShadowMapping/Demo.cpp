...
void Demo::Render() {
	...
	lightView = glm::lookAt(glm::vec3(-2.0f, 4.0f, -1.0f), glm::vec3(0.0f, 10.0f, 0.0f), glm::vec3(0.0, 1.0, 0.0));
...
void Demo::BuildTexturedCube()
{
	...
	int width, height;
	unsigned char* image = SOIL_load_image("metal.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
...
int main(int argc, char** argv) {
	...
	app.Start("Tugas 4 Shadow", 800, 600, false, false);
}